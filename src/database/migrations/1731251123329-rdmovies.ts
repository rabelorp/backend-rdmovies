...
export class Rdmovies1731251123329 implements MigrationInterface {
  name = 'Rdmovies1731251123329';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "movies" ("ratingId" uuid NOT NULL, "categoryId" uuid NOT NULL, "releaseDate" date NOT NULL, "description" text NOT NULL, "title" text NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c5b2c134e871bfd1c2fe7cc3705" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
